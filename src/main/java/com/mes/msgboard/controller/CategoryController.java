...
@RestController
@RequestMapping(path = "/api/${mes.api.version}/categories")
public class CategoryController implements ICategoryApi {
	...
	public ResponseEntity<CategoryResponse> createCategory(
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.CREATED).body(new CategoryResponseMapper()
					.apply(categoryService.createCategory(categoryRequest.getCategory())));
		} catch (Exception e) {
	...
	public ResponseEntity<CategoryResponse> updateCategory(@RequestBody CategoryRequest categoryRequest)
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.ACCEPTED).body(
					new CategoryResponseMapper().apply(categoryService.updateCategory(categoryRequest.getCategory())));
		} catch (Exception e) {
			if (e instanceof MESException) {
				throw e;
			}
	...
	@ApiImplicitParam(paramType="header",name="Authorization",required=true)
	@ResponseStatus(code = HttpStatus.NO_CONTENT)
	public ResponseEntity<CategoryResponse> disbaleDiscussion(
			@ApiParam(name = "categoryId", required = true) @PathVariable("categoryId") String id)
			throws NumberFormatException, MESException {
		try {
	...
	@ApiImplicitParam(paramType="header",name="Authorization",required=true)
	@ResponseStatus(code = HttpStatus.OK)
	public ResponseEntity<CategoryResponse> searchCategoryByName(
